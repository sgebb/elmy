...
var author$project$Main$MatchResult = F3(
	function (votesFor, votesAgainst, opposition) {
		return {opposition: opposition, votesAgainst: votesAgainst, votesFor: votesFor};
	});
...
var author$project$Main$resultDecoder = A4(
	...
	A2(elm$json$Json$Decode$field, 'opposition', elm$json$Json$Decode$int));
...
var author$project$Main$init = function (_n0) {
	...
	var char1 = author$project$Main$nullCharacter;
	var a = elm$core$Platform$Cmd$batch(
		_List_fromArray(
...
var author$project$Main$NumbersRolled = function (a) {
	return {$: 'NumbersRolled', a: a};
};
...
var author$project$Main$charNumber = F2(
	function (_int, model) {
		var maybeChar = A2(
			elm$core$Array$get,
			_int,
			elm$core$Array$fromList(model.charList));
...
var author$project$Main$randomCharNumbers = function (charList) {
	return A2(
		elm$random$Random$pair,
		A2(
			elm$random$Random$int,
			0,
			elm$core$List$length(charList) - 1),
		A2(
			elm$random$Random$int,
			0,
			elm$core$List$length(charList) - 1));
			...
			case 'GotCharacters':
				...
				if (result.$ === 'Err') {
					...
					return _Utils_Tuple2(
						...
						A2(
							elm$random$Random$generate,
							author$project$Main$NumbersRolled,
							author$project$Main$randomCharNumbers(charList)));
				}
			case 'CharPicked':
				var _char = msg.a;
				return _Utils_Tuple2(
					...
					A2(
						elm$random$Random$generate,
						author$project$Main$NumbersRolled,
						author$project$Main$randomCharNumbers(model.charList)));
			default:
				var intTuple = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							charOne: A2(author$project$Main$charNumber, intTuple.a, model),
							charTwo: A2(author$project$Main$charNumber, intTuple.b, model)
						}),
...
var author$project$Main$bigSmashUrl = function (_char) {
	return A3(
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$id('header-item')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('item'),
						elm$html$Html$Attributes$id('leftChar-item')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('charImage'),
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('item'),
						elm$html$Html$Attributes$id('vstext-item')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('item'),
						elm$html$Html$Attributes$id('rightChar-item')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('item'),
						elm$html$Html$Attributes$id('underText-item')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
